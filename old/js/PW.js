define(function(require,exports,module){
	...
	var moveRem=require('move.js').moveRem;
	var findDir=require('container.js').findDir;
	var loaded=require('scroll.js').loaded;
	var loadArr=require('src.js').loadArr;
	var Tween=require('move.js').Tween;
											...
											'<div id="scroller4">'+
												'<ul class="ulist">'+
													...
													'<li>'+
														...
														'<a href="javascript:;">公众号:bluesun6688</a>'+
													'</li>'+
													'<li>'+
